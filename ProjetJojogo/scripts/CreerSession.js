...
function initialiserAutocompletionAdresse() {
    ...
    fetch(url)
      ...
      .then(donnees => {
        ...
        donnees.forEach(element => {
          ...
          if (element.type === 'house' || element.type === 'street' || element.type === 'information' || element.type === 'park'|| element.type === 'stadium' || element.type === 'sports_centre' || element.type === 'pitch') {
